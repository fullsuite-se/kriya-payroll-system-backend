...
//base path: /api/v1/daily-records/companies/:company_id/attendances
/**
 * ?from
 * ?to
 * ?employee_id
 */
router.get(
  "/companies/:company_id/attendances",
...
router.patch(
  "/companies/:company_id/attendances/:employee_attendance_id",
...
router.post(
  "/companies/:company_id/overtimes",
  overtimeController.addOneOvertime
); //add one only
router.patch(
  "/companies/:company_id/overtimes/:employee_overtime_id",
  overtimeController.updateOneOvertime
);
router.delete(
  "/companies/:company_id/overtimes/:employee_overtime_id",
  overtimeController.deleteOneOvertime
);
...
router.patch(
  "/companies/:company_id/absences/:employee_absence_id",
  absenceController.updateOneAbsence
);
router.delete(
  "/companies/:company_id/absences/:employee_absence_id",
  absenceController.deleteOneAbsence
);
...
router.patch(
  "/companies/:company_id/leaves/:employee_leave_id",
  leaveController.updateOneLeave
);
router.delete(
  "/companies/:company_id/leaves/:employee_leave_id",
  leaveController.deleteOneLeave
);
...
router.patch(
  "/companies/:company_id/restdays/:employee_restday_id",
  restdayController.updateOneRestday
);
router.delete(
  "/companies/:company_id/restdays/:employee_restday_id",
  restdayController.deleteOneRestday
);
